          ...
          IconButton(
            ...
            onPressed: () async {
              ...
              if (resultado is List) {
                // Si se devolvió una lista, actualiza el carrito local
                setState(() {
                  _carrito
                    ..clear()
                    ..addEntries(
                      resultado.map((e) => MapEntry(e['codigo'], e)),
                    );
                });
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                if (docs.isEmpty) {
                  return const Center(
                    child: Text('No hay bebidas registradas.'),
                  );
                }
                ...
                return GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final dynamic rawValoracion = data['valoracion'] ?? 0;
                    final double valoracion =
                        rawValoracion is num
                            ? rawValoracion.toDouble()
                            : double.tryParse(rawValoracion.toString()) ?? 0.0;
